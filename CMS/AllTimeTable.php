		...
		<div class="col-md-4 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          <span class="edusec-link-box-text"><a href="FTimetable.php">College TimeTable</a></span>
...
<div class="col-md-4 col-sm-6 col-xs-12">
              <div class="edusec-link-box">
                ...
                <div class="edusec-link-box-content">
                  <span class="edusec-link-box-text"><a href="TranspotationTimeTable.php">Bus TimeTable</a></span>
                 </div><!-- /.info-box-content -->
              </div><!-- /.info-box -->
        </div>
