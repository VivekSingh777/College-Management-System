...
// Settings
	...
	$extension_whitelist = array("jpg", "gif", "png" ,"pdf","doc","tex","zip","js","css");	// Allowed file extensions
...
// Process the file
	/*
		...
		been saved.
	*/
	if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], dirname(__FILE__).'/res/'.$file_name)) {
