...
<li><a href="?controller=admin&action=complain">Complain</a></li>
<li><a href="?controller=admin&action=viewcomplains">view Complain</a></li>
<li class="active">Reply</li>
</ul>

    <section class="content">
        <div class="col-xs-12">
  <div class="col-lg-4 col-sm-4 col-xs-12 no-padding"><h3 class="box-title"><i class="fa fa-plus"></i> reply</h3></div>
...
<label class="control-label" for="stuinfo-stu_start_date">Enter Reply</label>
...
<textarea id="msgofday-msg_details" class="form-control" required name="reply_description" maxlength="200" placeholder="Enter discription of complain"></textarea>
